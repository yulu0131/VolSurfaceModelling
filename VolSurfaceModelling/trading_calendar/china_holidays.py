...
def _is_china_holidays(date: datetime.date):
    ...
    _is_holiday = (
        ...
        or (y == 2022 and (1 <= d <= 6) and m == 2)
        or (y == 2022 and d == 31 and m == 1)
        # QingMing Festival
        ...
        or (y == 2022 and d == 30 and m == 4)
        or (y == 2022 and 1 <= d <= 4 and m == 5)
